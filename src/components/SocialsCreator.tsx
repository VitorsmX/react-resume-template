...
import {socialLinksCreator} from '../data/data';

const SocialsCreator: FC = memo(() => {
  return (
    <>
      {socialLinksCreator.map(({label, Icon, href}) => (
        <a
          aria-label={label}
...
SocialsCreator.displayName = 'SocialsCreator';
export default SocialsCreator;
